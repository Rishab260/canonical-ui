...
class Artifact(models.Model):
    ...
    document = models.FileField(upload_to='artifacts/%Y/%m/%d/', blank=True, null=True)  # For file uploads (docs, PDFs, etc.)
    hyperlink = models.URLField(blank=True, null=True)  # For hyperlinks (external URLs)
    description = models.CharField(max_length=255, blank=True, null=True)  # Optional description for the artifact
